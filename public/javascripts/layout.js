let makeItRain = function() {
    ...
    while (increment < 100) {
      ...
      let randoRiver = (Math.floor(Math.random() * (97 - 1 + 1) + 1));
      //increment
      inc = randoRiver;
      ...
      drops += '<div class="drop" style="top: 30px; left: ' + inc + '%; bottom: ' + inc + '%; animation-delay: 0.' + randoHundo + 's; animation-duration: 2.5' + randoHundo + 's;"><div class="stem" style="animation-delay: 0.' + randoHundo + 's; animation-duration: 1.' + randoHundo + 's; background:' + colorArray[comboColor] + '"></div><div class="splat" style="animation-delay: 0.' + randoHundo + 's; animation-duration: 1.9' + randoHundo + 's; background:' + colorArray[comboColor] + '"></div></div>';
